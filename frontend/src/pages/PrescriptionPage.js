        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 12, color: theme.colors.subtext, marginTop: 4 }}>
                {previewUrl ? "업로드된 처방전 이미지" : "아직 업로드된 이미지 없음"}
              </div>
            </div>
                ...
                <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 160 }}>
                    ...
                    <input
                      ...
                      onChange={(e) => handleChange("patientIdMasked", e.target.value)}
                      style={inputStyle}
                    />
                  </div>
                </div>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                ...
                <div style={{ flex: 1, minWidth: 140 }}>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange("hospitalFax", e.target.value)}
                    style={inputStyle}
                  />
                </div>
              </div>
              ...
              <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 12 }}>
                {form.medicines.map((item, idx) => (
                  ...
                  >
                    ...
                    >
                      <div style={{ fontSize: 13, fontWeight: 800, color: theme.colors.subtext }}>
                        약품 #{idx + 1}
                      </div>
                      <button
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 10 }}>
                      ...
                      >
                        <div>
                          ...
                          <input
                            value={item.code}
                            onChange={(e) => handleMedicineChange(idx, "code", e.target.value)}
                            style={inputStyle}
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleMedicineChange(idx, "timesPerDay", e.target.value)
                            }
                            style={inputStyle}
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            value={item.usage}
                            onChange={(e) => handleMedicineChange(idx, "usage", e.target.value)}
                            style={inputStyle}
                          />
                        </div>
